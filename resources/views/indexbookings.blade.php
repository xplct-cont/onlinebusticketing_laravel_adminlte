...
<body>
    ...
    <div> 
       <div class="search">
                ...
                <form action="{{ route('indexbookings') }}" method="GET" role="search">
                    ...
                    <div class="input-group">
                        ...
                        <a href="{{ route('indexbookings') }}" class=" mt-0">
            ...
            <div class="card card-outline card-dark">
             <table class="table table-hover text-center text-dark">
              ...
              <tr>
               ...
               <th class="bg-info">Drop Time</th>
               <th class="bg-info">Ticket No</th>
              ...
              <tr>
                <td class="text-sm font-weight-normal">{{ $item->operator }}</td>
                <td class="text-sm font-weight-normal">{{ $item->bus_name }}</td>
                <td class="text-sm font-weight-normal">{{ $item->point_of_origin }}</td>
                <td class="text-sm font-weight-normal">{{ $item->start_time }}</td> 
                <td class="text-sm font-weight-normal">{{ $item->destination }}</td> 
                <td class="text-sm font-weight-normal">{{ $item->drop_time }}</td> 
                <td class="text-sm font-weight-normal">{{ $item->ticket_no }}</td>
                <td class="text-sm font-weight-normal">{{ $item->passenger_name }}</td>
                <td class="text-sm font-weight-normal">{{ $item->age }}</td>
                <td class="text-sm font-weight-normal">{{ $item->contact_no }}</td>
              </tr>
